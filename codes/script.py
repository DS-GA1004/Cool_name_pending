...
df1.write.format("com.databricks.spark.csv").option("header", "true").option("delimiter",",").save("complain_cleaned")
...
if ("property" in filename):
	...
	df2.write.format("com.databricks.spark.csv").option("header", "true").option("delimiter",",").save("property_cleaned")

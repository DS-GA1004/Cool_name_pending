...
df2 = sqlCtx.read.format('csv').options(header='true',inferschema='true').load("/user/hk2451/complain_cleaned")
...
MImatdf.write.format("com.databricks.spark.csv").option("header", "true").option("delimiter",",").save("property_complain"+str(years[k]))

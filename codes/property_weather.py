...
df2 = sqlCtx.read.format('csv').options(header='true',inferschema='true').load("/user/hk2451/weather_cleaned")
...
MImatdf.write.format("com.databricks.spark.csv").option("header", "true").option("delimiter",",").save("property_weather"+str(years[k]))
